Public Class ModifierStagiaire
    ...
    Private Sub Enregistrer_btn_Click(sender As Object, e As EventArgs) Handles Enregistrer_btn.Click
        ...
        con.Open()
        cmd.CommandType = CommandType.Text
        cmd.CommandText = "update Stagiaire set Nom_stg='" & TextBox2.Text & "',prenom='" & TextBox3.Text & "',Nom_rsp='" & ComboBox3.Text & "',Age='" & ComboBox1.Text & "',sexe='" & ComboBox2.Text & "',Adresse='" & TextBox4.Text & "',Telephone='" & TextBox5.Text & "' where ID_stg =" & Integer.Parse(TextBox1.Text)
        cmd.ExecuteNonQuery()
